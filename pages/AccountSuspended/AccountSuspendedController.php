...
/**
 * Just a simple controller to bring up the static "account suspended" screen.
 */
class AccountSuspendedController extends RetwitterPageController
    implements IGetControllerAsync
{
    public function getAsync(): Promise
    {
        return async(function()
        {
            ...
            $this->setPageContext(new AccountSuspendedPageContext());
