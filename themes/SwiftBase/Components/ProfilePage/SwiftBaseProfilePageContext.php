 ...
 */
class SwiftBaseProfilePageContext extends BasePageContext implements IThemeProfilePageContext
{
    ...
    public function insertUserData(IProfileDataParser $parser): void
    {
        ...
        {
            $this->insertUserDataHandleSuccess($parser);
        }
    ...
    protected function setUpTitle(IProfileDataParser $parser): void
    {
