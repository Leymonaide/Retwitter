...
namespace Retwitter\Theme\SwiftRosetta;
...
return new class extends AbstractTheme
{
    ...
    {
        return ThemeManager::loadTheme("SwiftBase");
    }
    ...
    public function getModelFactory(): SwiftRosettaThemeModelFactory
    {
        return new SwiftRosettaThemeModelFactory();
    }
