...
/**
 * Implements the Retwitter Cache Server autoloader.
 * 
 * This is forked from the standard autoloader, as the autoloader runs in a
 * command line PHP environment which doesn't support a few hardcoded constants
 * of the Rehike version.
 * 
 * @version 2.0
...
class Autoloader
{
    ...
    {
        $path = Arguments::$s_rootDirectory . "/" . $filename;
