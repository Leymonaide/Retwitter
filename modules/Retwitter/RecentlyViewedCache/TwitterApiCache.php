...
class TwitterApiCache implements ICacheData
{
    public function __construct(
        private readonly object $twitterApiResult,
    )
    {
    }
    ...
    {
        return $this->twitterApiResult;
    }

    public function jsonSerialize(): string
    {
        return json_encode((object)[
            "api_source" => ApiSource::TwitterWeb->name,
            "twitter_api_result" => json_encode($this->twitterApiResult),
        ]);
    }
    ...
    public static function fromJson(string $json): static
    {
        ...
        $inst->twitterApiResult = json_decode($obj->twitter_api_result);
